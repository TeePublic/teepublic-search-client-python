...
class SearchApi(object):
    ...
    def post_artist_search(self, body, **kwargs):  # noqa: E501
        """Performs search on active designs by artist  # noqa: E501

        Performs search on designs by artist username or slug which are discoverable and non-affiliate  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_artist_search(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ArtistSearchRequest body: User Search Request (required)
        ...
        if kwargs.get('async_req'):
            return self.post_artist_search_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_artist_search_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_artist_search_with_http_info(self, body, **kwargs):  # noqa: E501
        """Performs search on active designs by artist  # noqa: E501

        Performs search on designs by artist username or slug which are discoverable and non-affiliate  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_artist_search_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method post_artist_search" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('body' not in params or
            ...
            raise ValueError("Missing the required parameter `body` when calling `post_artist_search`")  # noqa: E501
    ...
    def post_v1_category_search(self, body, **kwargs):  # noqa: E501
        """Endpoint to retrieve discoverable designs associated with a given category.  # noqa: E501

        Returns a list of discoverable designs associated with a given category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v1_category_search(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CategorySearchRequestV1 body: Request object for category search. (required)
        :return: SearchResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v1_category_search_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v1_category_search_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_v1_category_search_with_http_info(self, body, **kwargs):  # noqa: E501
        """Endpoint to retrieve discoverable designs associated with a given category.  # noqa: E501

        Returns a list of discoverable designs associated with a given category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v1_category_search_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_v1_category_search" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `post_v1_category_search`")  # noqa: E501
