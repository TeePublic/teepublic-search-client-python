...
class TagApi(object):
    ...
    def post_v1_related_tags_cleanup(self, body, **kwargs):  # noqa: E501
        """Removes deleted related tag relationships.  # noqa: E501

        Removes deleted related tag relationships.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v1_related_tags_cleanup(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body: Include a timestamp field for cleanup. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_v1_related_tags_cleanup_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_v1_related_tags_cleanup_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_v1_related_tags_cleanup_with_http_info(self, body, **kwargs):  # noqa: E501
        """Removes deleted related tag relationships.  # noqa: E501

        Removes deleted related tag relationships.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_v1_related_tags_cleanup_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_v1_related_tags_cleanup" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_v1_related_tags_cleanup`")  # noqa: E501
