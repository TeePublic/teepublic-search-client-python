...
class DesignSlim(object):
    ...
    def __init__(self, id=None, title=None, primary_tag=None, primary_related_tags=None, secondary_tags=None, sales=None, fam_approved=None, click_through_rate=None, explanation=None, _configuration=None):  # noqa: E501
