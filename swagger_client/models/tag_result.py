...
class TagResult(object):
    ...
    def __init__(self, id=None, name=None, taggings=None, suggestable=None, canonical=None, relatable=None, deleted=None, child_count=None, parent_name=None):  # noqa: E501
