...
class TagResult(object):
    ...
    def __init__(self, id=None, name=None, taggings=None, discoverable_taggings=None, mature=None, suggestable=None, canonical=None, relatable=None, deleted=None, child_count=None, parent_name=None, _configuration=None):  # noqa: E501
