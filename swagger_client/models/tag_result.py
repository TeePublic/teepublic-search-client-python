...
class TagResult(object):
    ...
    def __init__(self, id=None, name=None, taggings=None, linkable_count=None, suggestable=None, canonical=None, relatable=None, deleted=None, child_count=None, parent_name=None):  # noqa: E501
        """TagResult - a model defined in Swagger"""  # noqa: E501

        self._id = None
        self._name = None
        self._taggings = None
        self._linkable_count = None
        ...
        if linkable_count is not None:
            self.linkable_count = linkable_count
    ...
    @property
    def linkable_count(self):
        """Gets the linkable_count of this TagResult.  # noqa: E501

        teepublic approved design taggings count  # noqa: E501

        :return: The linkable_count of this TagResult.  # noqa: E501
        :rtype: int
        """
        return self._linkable_count

    @linkable_count.setter
    def linkable_count(self, linkable_count):
        """Sets the linkable_count of this TagResult.

        teepublic approved design taggings count  # noqa: E501

        :param linkable_count: The linkable_count of this TagResult.  # noqa: E501
        :type: int
        """

        self._linkable_count = linkable_count
