...
class DmcaSearchRequestV2(object):
    ...
    def __init__(self, search_terms=None, teepublic_approved=True, teepublic_unapproved=False, artist_id=None, per_page=36, page_offset=1, sort='relevance'):  # noqa: E501
