...
class SetDesignTaggingsObject(object):
    ...
    def __init__(self, design_id=None, discoverable=None, discoverable_before=None, primary=None, secondary=None, _configuration=None):  # noqa: E501
        ...
        self._discoverable_before = None
        self._primary = None
    ...
    @property
    def discoverable_before(self):
        """Gets the discoverable_before of this SetDesignTaggingsObject.  # noqa: E501

        true if the design was already discoverable  # noqa: E501

        :return: The discoverable_before of this SetDesignTaggingsObject.  # noqa: E501
        :rtype: bool
        """
        return self._discoverable_before

    @discoverable_before.setter
    def discoverable_before(self, discoverable_before):
        """Sets the discoverable_before of this SetDesignTaggingsObject.

        true if the design was already discoverable  # noqa: E501

        :param discoverable_before: The discoverable_before of this SetDesignTaggingsObject.  # noqa: E501
        :type: bool
        """
        if self._configuration.client_side_validation and discoverable_before is None:
            raise ValueError("Invalid value for `discoverable_before`, must not be `None`")  # noqa: E501

        self._discoverable_before = discoverable_before
