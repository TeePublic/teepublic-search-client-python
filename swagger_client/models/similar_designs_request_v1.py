...
class SimilarDesignsRequestV1(object):
    ...
    attribute_map = {
        'ref_anonymous_id': 'ref_anonymous_id',
    ...
    def __init__(self, ref_anonymous_id=None, ref_design_id=None, search_terms=None, sort='relevance', tags_filter=None, canvases=None, artist_filter=None, per_page=36, page_offset=1, explain=False, es_explain=False, relevancy_config_id=None, bucket=None, safe_search=True, _configuration=None):  # noqa: E501
        """SimilarDesignsRequestV1 - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._ref_anonymous_id = None
        ...
        if ref_anonymous_id is not None:
            self.ref_anonymous_id = ref_anonymous_id
    ...
    @property
    def ref_anonymous_id(self):
        """Gets the ref_anonymous_id of this SimilarDesignsRequestV1.  # noqa: E501

        reference anonymous user id  # noqa: E501

        :return: The ref_anonymous_id of this SimilarDesignsRequestV1.  # noqa: E501
        :rtype: str
        """
        return self._ref_anonymous_id

    @ref_anonymous_id.setter
    def ref_anonymous_id(self, ref_anonymous_id):
        """Sets the ref_anonymous_id of this SimilarDesignsRequestV1.

        reference anonymous user id  # noqa: E501

        :param ref_anonymous_id: The ref_anonymous_id of this SimilarDesignsRequestV1.  # noqa: E501
        :type: str
        """

        self._ref_anonymous_id = ref_anonymous_id
