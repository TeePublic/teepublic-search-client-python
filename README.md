...
*TagApi* | [**get_v1_tag_parent_child_mapping**](docs/TagApi.md#get_v1_tag_parent_child_mapping) | **GET** /v1/tag-parent-child-mapping | Gets tag mapping for a seed tag or normalized search term
...
## Documentation For Models
 ...
 - [TagMappingResponse](docs/TagMappingResponse.md)
