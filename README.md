...
*DesignsApi* | [**post_v1_similar_designs**](docs/DesignsApi.md#post_v1_similar_designs) | **POST** /v1/similar-designs | Returns a list of discoverable designs based on a reference design and/or primary tag.
...
*ServiceApi* | [**healthcheck_get**](docs/ServiceApi.md#healthcheck_get) | **GET** /healthcheck | Check if the service is running
*TagApi* | [**get_v1_design_tags**](docs/TagApi.md#get_v1_design_tags) | **GET** /v1/design-tags | Gets tags for a design
*TagApi* | [**get_v1_link_graph**](docs/TagApi.md#get_v1_link_graph) | **GET** /v1/link-graph | Retrieves the status of tags considered for our link graph.
...
*TagApi* | [**post_v1_link_graph**](docs/TagApi.md#post_v1_link_graph) | **POST** /v1/link-graph | Sets the status of tags considered for our link graph.
...
## Documentation For Models
 ...
 - [LinkGraphResponse](docs/LinkGraphResponse.md)
 ...
 - [SetLinkGraphRequest](docs/SetLinkGraphRequest.md)
 - [SetLinkGraphResponse](docs/SetLinkGraphResponse.md)
