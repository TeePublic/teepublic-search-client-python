...
*TagApi* | [**post_v1_related_tags_cleanup**](docs/TagApi.md#post_v1_related_tags_cleanup) | **POST** /v1/related-tags/cleanup | Removes deleted related tag relationships.
